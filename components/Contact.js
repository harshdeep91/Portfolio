      ...
      <div name='contact' className="bg-[#0a192f] w-full h-screen text-gray-300 flex justify-center items-center p-4">
          <form action="https://getform.io/f/dca77663-3f18-4892-bcbe-b1849cb984ba" method="POST" className="flex flex-col max-w-2xl w-full">
              <div className="pb-8">
                  ...
                  <p className="py-4">
                  &#8427; Submit the form below or shoot me an email - harshdeepraghuwanshi@gmail.com
                  </p>
              </div>
              ...
              <textarea className="bg-gray-500 p-2" name="message" rows='10' placeholder="Message"/>
              <button className="text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-2 mx-auto my-8">Lets Collaborate</button>
          </form>
      </div>
  )
}
